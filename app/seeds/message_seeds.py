...
winter_soldier_messages = [
  ...
  Message(author_id=7, channel_id=2, content='It\'s your bed, it\'s too soft. When I was over there I sleep on the ground, use rock for pillows like a caveman.'),
  Message(author_id=7, channel_id=2, content='Now I\'m home, lying in my bed, and it\'s like…'),
  ...
  Message(author_id=6, channel_id=2, content='Well, things aren\'t so bad. Food\'s a lot better (we used to boil everything). No polio\'s good.'),
  Message(author_id=6, channel_id=2, content='Internet! So helpful. Been reading that a lot trying to catch up.'),
